...
export async function POST(request: Request) {
  ...
  try {
    ...
    const t: DbTest = {
      ...
      clientReportHtmlTemplate: body.clientReportHtmlTemplate,
      professionalReportHtmlTemplate: body.professionalReportHtmlTemplate,
      scaleInterpretations: body.scaleInterpretations,
      showClientReport: body.showClientReport ?? true,
