...
export function toApiTest(t: DbTest, attemptsCount?: number): Test {
  ...
  return {
    ...
    clientReportHtmlTemplate: t.clientReportHtmlTemplate,
    professionalReportHtmlTemplate: t.professionalReportHtmlTemplate,
    scaleInterpretations: t.scaleInterpretations,
    showClientReport: t.showClientReport ?? true,
